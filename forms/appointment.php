<?php
  ...
  */
  ...
  // Ganti contact@example.com dengan alamat email penerima asli Anda
  $receiving_email_address = 'info@restuibu.com';

  if( file_exists($php_email_form = '../assets/vendor/php-email-form/php-email-form.php' )) {
    include( $php_email_form );
  } else {
    die( 'Tidak dapat memuat Pustaka "PHP Email Form"!');
  }
